...
class OCRSettings(BaseModel):
    ...
    warden_icon_path: str | None = Field(
        default="data/warden_icon.png",
        description="Path to warden faction icon for template matching",
    )
    ...
    @field_validator("colonial_icon_path", "warden_icon_path")
    @classmethod
